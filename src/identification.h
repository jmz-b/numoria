...
// And for colors
extern int16_t potion_colors[MAX_POTIONS];
extern int16_t mushroom_colors[MAX_MUSHROOMS];
extern int16_t wood_colors[MAX_WOODS];
extern int16_t metal_colors[MAX_METALS];
extern int16_t rock_colors[MAX_ROCKS];
extern int16_t amulet_colors[MAX_AMULETS];
